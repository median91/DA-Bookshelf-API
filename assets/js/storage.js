function getData() {
  ...
  function renderData(books = []) {
    const inCompleted = document.querySelector("#incompleteBookshelf");
    const completed = document.querySelector("#completeBookshelf");
  ...
  function removeBook(id) {
    let cfm = confirm("Yakin akan menghapus data buku ini ?");
  ...
  function readedBook(id) {
    let cfm = confirm("Pindahkan buku kedalam[SELESAI DIBACA] ?");
  ...
  function unreadedBook(id) {
    let cfm = confirm("Pindahkan buku kedalam [BELUM SELESAI DIBACA] ?");
